...
urlpatterns = [
    ...
    re_path(r'^update_metadata/(?P<job_id>[0-9A-Za-z_\-]+)/(?P<metadata_type>[0-9A-Za-z_\-]+)/$', 'enable_disable.views.update_metadata'),
    re_path(r'^check_deploy_status/(?P<deploy_job_id>\d+)/$', 'enable_disable.views.check_deploy_status'),
    path('^auth_details/$', 'enable_disable.views.auth_details'),
]
